...
Generally, these tools use the slurm \href{https://slurm.schedmd.com/sacct.html}{sacct} command (or the non-slurm equivalent of this command if an alternative job scheduler is being used) to gather information about completed jobs and calculates their carbon emissions based on the CI at the job's run time. 
