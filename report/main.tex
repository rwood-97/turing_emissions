...
Using the national grid approach with daily average CIs, the Turing's operational emissions over its entire use of Baskerville were 39.2 tCO${_2}$e and its operational emissions in the past year were 8.7 tCO${_2}$e. 
...
Notably, this is around 29\% higher than calculated using daily average CIs, though it is unclear where these differences arise.
