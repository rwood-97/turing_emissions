...
In the past year, the Turing ran jobs summing to 138,073 GPUh and so our emissions rate is \qty[qualifier-mode=combine]{81.3}{\gramme\of{\cooe}\per\GPUh} (using the \unit{GPUh} and emissions values reported by GRACE-HPC). 
